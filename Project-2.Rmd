...
```{r}
data$survey_company <- str_replace_all(data$survey_company, name_mapping)
```
...
We only kept observations for students who said they have accepted a fulltime or parttime job ignoring observations for students continuing education as it is not the focus of our analyses.
```{r}
